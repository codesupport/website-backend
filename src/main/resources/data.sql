...
INSERT INTO USER (ID,ALIAS,HASH_PASSWORD,EMAIL,AVATAR_LINK,ROLE_ID,DISABLED,BIOGRAPHY,GITHUB_USERNAME,DISCORD_USERNAME,COUNTRY_ID,JOIN_DATE) VALUES (4, 'Atrum', '$2a$10$OGVw0XltDpCZS949tqDhu.4ShJLI9sNCdmbjlCb3.PEkk.T0csCGi', 'atrum@cs.dev', 'atrum.jpg', null, false, 'Wut?', '', 'Atrum#1337', 1, 1570492800000);
INSERT INTO USER (ID,ALIAS,HASH_PASSWORD,EMAIL,AVATAR_LINK,ROLE_ID,DISABLED,BIOGRAPHY,GITHUB_USERNAME,DISCORD_USERNAME,COUNTRY_ID,JOIN_DATE) VALUES (5, 'Jason', '$2a$10$OGVw0XltDpCZS949tqDhu.4ShJLI9sNCdmbjlCb3.PEkk.T0csCGi', 'jason@cs.dev', 'jason.jpg', null, false, ':^)', '', 'Jason#dic2', 2, 1570492800000);
