...
INSERT INTO USER (ID,ALIAS,HASH_PASSWORD,EMAIL,AVATAR_LINK,ROLE_ID,DISABLED,BIOGRAPHY,GITHUB_USERNAME,DISCORD_USERNAME,COUNTRY_ID,JOIN_DATE) VALUES (2, 'Lambo', '$2a$10$KuNmt9tVAOvzvcjsiTFzFudhC9bpJbhJfLKiVwwRYCaAPR2LXxJKS', 'lam.bo@cs.dev', 'lambo.jpg', 1, false, 'Push my PR!', 'lambocreeper', 'LamboCreeper#666', 2, 1570406400000);
INSERT INTO USER (ID,ALIAS,HASH_PASSWORD,EMAIL,AVATAR_LINK,ROLE_ID,DISABLED,BIOGRAPHY,GITHUB_USERNAME,DISCORD_USERNAME,COUNTRY_ID,JOIN_DATE) VALUES (3, 'Iffy', '$2a$10$KuNmt9tVAOvzvcjsiTFzFudhC9bpJbhJfLKiVwwRYCaAPR2LXxJKS', 'if.fy@cs.dev', 'iffy.jpg', 1, false, 'Red sparkles and glitter', '', 'Iffy#<3<3', 2, 1570492800000);
