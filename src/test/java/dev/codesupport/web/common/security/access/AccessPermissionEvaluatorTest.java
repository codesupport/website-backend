...
public class AccessPermissionEvaluatorTest {
    ...
    @Test
    public void shouldCorrectlyGetAndInvokeEvaluatorByClassObjectCollection() {
        List<String> myObject = Collections.singletonList("my object");
        String permission = "read";
        ...
        doReturn(true)
                .when(mockAccessEvaluator)
                .hasPermission(mockAuthentication, myObject.get(0));
