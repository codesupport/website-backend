...
INSERT INTO USER (ID,ALIAS,HASH_PASSWORD,EMAIL,AVATAR_LINK,ROLE_ID,DISABLED,BIOGRAPHY,GITHUB_USERNAME,DISCORD_USERNAME,COUNTRY_ID,JOIN_DATE) VALUES (2, 'Lambo', '$2a$10$ss9M0jlCsYDEIA0iBnAyi.PK8TJhpv/Y.tpILVOMKXIvmkOov.Eim', 'lam.bo@cs.dev', 'lambo.jpg', 1, false, 'Push my PR!', 'lambocreeper', 'LamboCreeper#666', 2, 1570406400000);
INSERT INTO USER (ID,ALIAS,HASH_PASSWORD,EMAIL,AVATAR_LINK,ROLE_ID,DISABLED,BIOGRAPHY,GITHUB_USERNAME,DISCORD_USERNAME,COUNTRY_ID,JOIN_DATE) VALUES (3, 'Iffy', '$2a$10$ss9M0jlCsYDEIA0iBnAyi.PK8TJhpv/Y.tpILVOMKXIvmkOov.Eim', 'if.fy@cs.dev', 'iffy.jpg', 1, false, 'Red sparkles and glitter', '', 'Iffy#<3<3', 2, 1570492800000);
